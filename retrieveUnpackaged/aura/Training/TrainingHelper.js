({
	...
	createNewTraining : function(component) {
        console.log('CreateNewTraining function called');
    ...
    startSaving: function(component,event,saveActionType) {
        console.log('StartSaving function called');
    ...
    loadUserTrainings : function(component,event) {
        console.log('loadUserTrainings function called');
    ...
    deleteTrainingRecord : function(component,event) {
        console.log('deleteTrainingRecord function called');
    ...
    didCompleteSaveRecord:function(component,event){
        console.log('didCompleteSaveRecord function called');
    ...
    uploadProcess: function(component, file, fileContents) {
        console.log('uploadProcess function called');
    ...
    uploadInChunk: function(component, file, fileContents, startPosition, endPosition, attachId) {
        console.log('uploadInChunk function called');
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if (startPosition < endPosition && false) {
                    ...
                    try {
                        component.find("editTrainingRec").get("e.recordSave").fire();
                        component.set("v.triedToSaveTraining", true);              
                      }
                      catch (e) {
                        console.log(e);
                      }
