({
    ...
    openFormModal: function(component, event, formID, formName,formOption) {
        ...
        action.setCallback(this,function(resp){
            ...
            if(state === 'SUCCESS'){
                ...
                console.log('This is in the callback helper.openFormModal : v.nerFormId = ' + component.get('v.newFormId'));
    ...
    //Duplicate of 18-42 - James Lambert 1-23-18
    // setSiteUserID : function(component) {   // set siteUserID for temp record sharing         
    //     console.log("helper.setSiteUserID function called");
    ...
    //changed the function name to avoid possible conflicts. - james lambert 1/16/18
    saveAndSubmitHelper: function(component, event){
        //replacing my code with trellis' -James Lambert 1/17/18
        /*
        console.log("helper.saveAndSubmit function called");

        component.set("v.isSaveFired", true);
        console.log('v.isSaveFired' + component.get("v.isSaveFired"));
        try{
            component.find("edit").get("e.recordSave").fire();
            console.log('e.recordSave was fired');
        }catch (e) {
            console.log(e);
        }
        ...
        var formID;
        console.log('saveAndSubmit: v.modalName = ' + component.get("v.modalName")); 
        if (component.get("v.modalName") == 'viewForm') {
            formID = component.get("v.viewFormID");
            console.log('saveAndSubmit: formId = ' + formId);
        }
        else {
        ...
        if(formObj!=undefined){
            ...
            console.log("saveAndsubmit: recordTypeId = " + recordTypeId);
        }else{
            console.log("the formObj was undefined.");
        }
        
        console.log('fromID = ' + formID + ' v.sessionID = ' + component.get("v.sessionID") + ' recordTypeId = ' + recordTypeId );
